...
I picked up Chess(again!). Yeah yeah, I'll fix the formatting later.
...
FL has chessbase16+2019Megadb
Nothing on AR,TL,RED,GGn
...
Caïssabase http://caissabase.co.uk/  <- seems like the best free choice 
(FYI, Caïssa is the goddess of chess)

http://www.theweekinchess.com/twic
To download PGNs from TWIC:
```seq 1220 1230 | parallel -j10 wget http://www.theweekinchess.com/zips/twic{}g.zip ```
...
LINK COLLECTION TO CHESS GAMES AROUND THE INTERNET WHICH YOU CAN DOWNLOAD FOR FREE
...
Engines:
Stockfish - the most popular one
...
^Installed all these engines in scid vs pc (ubuntu)
...
Plan to contribute to Lichess via Fishnet. Have applied for Fishnet Key
...
Stop getting into chess drama. I spent my 4 hours reading up about the fat fritz 2 drama. Delving into all the articles/videos talking about it. It's not worth your precious time. Another reminder that TIME IS PRECIOUS!
...
https://www.youtube.com/playlist?list=PLBRObSmbZluRBQOO_6FzyxQUaFyzusSl0
